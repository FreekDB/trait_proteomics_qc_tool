...
#### Globals
my $version = '1.3.0beta'; # Multi-threading, remove MCP summary
my $version_date = '04-13-2012';
my $use_multiple_threads = 1;
...
my @instrument_types = ('LCQ', 'LXQ', 'LTQ', 'FT', 'ORBI', 'AGILENT_QTOF', 'ORBI_HCD', 'ORBI_CID', 'QEXACTIVE'); # Allowable instrument types.
